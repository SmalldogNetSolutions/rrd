INSERT INTO logdata (log_ts, wood_avail, public_heat, private_heat, hot_water, water_bottom, water_middle,
	light_level, solar_pump, boiler_temp, tank_temp, boiler_run, boiler_fire, aquistat, 
	kw_now, kw_today, kw_peak_today, 
	kw_now_g, kw_today_g, kw_peak_today_g, 
	thermostat1_temp, thermostat2_temp, thermostat3_temp,
...
SELECT date_trunc('minute',log_ts), 
	...
	avg(kw_now_g)::numeric(10,2) as kw_now_g,
	max(kw_today_g)::numeric(10,2) as kw_today_g,
	max(kw_peak_today_g)::numeric(10,2) as kw_peak_today_g,
